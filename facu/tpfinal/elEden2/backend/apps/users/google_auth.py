    ...
    try:
        ...
        try:
            ...
            try:
                ...
                logger.info(f"Persona y Cliente creados para {email} - Persona ID: {persona.id_persona}, Cliente ID: {cliente.id_cliente}")
...
def google_callback(request):
    ...
    """
    return Response({
        'message': 'Use el endpoint /api/v1/auth/google/ con el token de Google'
    })
