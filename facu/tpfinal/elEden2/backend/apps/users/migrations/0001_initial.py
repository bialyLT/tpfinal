    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["cp"], name="localidad_cp_7472d8_idx"),
                    models.Index(fields=["nombre_provincia"], name="localidad_nombre__322201_idx"),
                ],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nombre_contacto",
                    models.CharField(help_text="Nombre de la persona de contacto", max_length=200),
                ),
                ("email", models.EmailField(max_length=254)),
                ("telefono", models.CharField(max_length=20)),
                (
                    "direccion",
                    models.CharField(help_text="Dirección completa del proveedor", max_length=300),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["cuit"], name="proveedor_cuit_5d9233_idx"),
                    models.Index(fields=["razon_social"], name="proveedor_razon_s_b521be_idx"),
                    models.Index(fields=["email"], name="proveedor_email_9a716e_idx"),
                ],
            },
        ),
        migrations.AddIndex(
