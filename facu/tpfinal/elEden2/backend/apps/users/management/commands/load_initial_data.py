...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        localidades_data = [
            # Buenos Aires
            {'cp': '1900', 'nombre_localidad': 'La Plata', 'nombre_provincia': 'Buenos Aires'},
            {'cp': '7600', 'nombre_localidad': 'Mar del Plata', 'nombre_provincia': 'Buenos Aires'},
            {'cp': '8000', 'nombre_localidad': 'Bahía Blanca', 'nombre_provincia': 'Buenos Aires'},
            {'cp': '1000', 'nombre_localidad': 'CABA', 'nombre_provincia': 'Capital Federal'},
            
            # Córdoba
            {'cp': '5000', 'nombre_localidad': 'Córdoba', 'nombre_provincia': 'Córdoba'},
            {'cp': '5800', 'nombre_localidad': 'Río Cuarto', 'nombre_provincia': 'Córdoba'},
            
            # Santa Fe
            {'cp': '3000', 'nombre_localidad': 'Santa Fe', 'nombre_provincia': 'Santa Fe'},
            ...
            # Entre Ríos
            {'cp': '3100', 'nombre_localidad': 'Paraná', 'nombre_provincia': 'Entre Ríos'},
            
            # Misiones
            {'cp': '3300', 'nombre_localidad': 'Posadas', 'nombre_provincia': 'Misiones'},
            
            # Chaco
            {'cp': '3500', 'nombre_localidad': 'Resistencia', 'nombre_provincia': 'Chaco'},
            
            # Corrientes
            {'cp': '3400', 'nombre_localidad': 'Corrientes', 'nombre_provincia': 'Corrientes'},
            
            # Santiago del Estero
            {'cp': '4200', 'nombre_localidad': 'Santiago del Estero', 'nombre_provincia': 'Santiago del Estero'},
            
            # Jujuy
            {'cp': '4600', 'nombre_localidad': 'San Salvador de Jujuy', 'nombre_provincia': 'Jujuy'},
            
            # Catamarca
            {'cp': '4700', 'nombre_localidad': 'San Fernando del Valle de Catamarca', 'nombre_provincia': 'Catamarca'},
            
            # La Rioja
            {'cp': '5300', 'nombre_localidad': 'La Rioja', 'nombre_provincia': 'La Rioja'},
            
            # San Juan
            {'cp': '5400', 'nombre_localidad': 'San Juan', 'nombre_provincia': 'San Juan'},
            
            # San Luis
            {'cp': '5700', 'nombre_localidad': 'San Luis', 'nombre_provincia': 'San Luis'},
            
            # Neuquén
            {'cp': '8300', 'nombre_localidad': 'Neuquén', 'nombre_provincia': 'Neuquén'},
            
            # Río Negro
            {'cp': '8500', 'nombre_localidad': 'Viedma', 'nombre_provincia': 'Río Negro'},
            {'cp': '8400', 'nombre_localidad': 'San Carlos de Bariloche', 'nombre_provincia': 'Río Negro'},
            
            # Chubut
            {'cp': '9100', 'nombre_localidad': 'Trelew', 'nombre_provincia': 'Chubut'},
            {'cp': '9000', 'nombre_localidad': 'Comodoro Rivadavia', 'nombre_provincia': 'Chubut'},
            
            # Santa Cruz
            {'cp': '9400', 'nombre_localidad': 'Río Gallegos', 'nombre_provincia': 'Santa Cruz'},
            
            # Tierra del Fuego
            {'cp': '9410', 'nombre_localidad': 'Ushuaia', 'nombre_provincia': 'Tierra del Fuego'},
            
            # Formosa
            {'cp': '3600', 'nombre_localidad': 'Formosa', 'nombre_provincia': 'Formosa'},
            
            # La Pampa
            {'cp': '6300', 'nombre_localidad': 'Santa Rosa', 'nombre_provincia': 'La Pampa'},
        ]
        ...
        for loc_data in localidades_data:
            ...
            if created:
                ...
                self.stdout.write(f'   ✅ Localidad creada: {loc_data["nombre_localidad"]}, {loc_data["nombre_provincia"]}')
            else:
                self.stdout.write(f'   ℹ️  Localidad ya existe: {loc_data["nombre_localidad"]}, {loc_data["nombre_provincia"]}')
