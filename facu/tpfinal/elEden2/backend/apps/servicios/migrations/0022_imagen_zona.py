    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen', models.ImageField(help_text='Imagen de la zona', upload_to='zonas/%Y/%m/')),
                ...
                ('zona', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='imagenes', to='servicios.zonajardin')),
            ],
            options={
                'verbose_name': 'Imagen de Zona',
                'verbose_name_plural': 'Imágenes de Zona',
                'db_table': 'imagen_zona',
                'indexes': [models.Index(fields=['zona'], name='imagen_zona_zon_12345_idx'), models.Index(fields=['orden'], name='imagen_zona_orden_12345_idx')],
            },
        ),
    ]
