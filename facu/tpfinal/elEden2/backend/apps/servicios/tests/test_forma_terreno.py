...
class FormaTerrenoAPITests(TestCase):
    ...
    def test_post_forma_terreno_non_admin_forbidden(self):
        ...
        user = User.objects.create_user(username='user_test', password='testpass')
    ...
    def test_post_forma_terreno_admin_allowed(self):
        admin = User.objects.create_superuser(username='admin_test', email='admin@example.com', password='adminpass')
