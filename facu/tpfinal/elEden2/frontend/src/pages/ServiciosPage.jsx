      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          <div className="flex flex-col sm:flex-row gap-4 mb-4">
            {/* Search */}
            <div className="flex-1">
              <span className="block text-xs text-gray-400 mb-1">Buscar</span>
            ...
            {/* Status Filter */}
            <div>
              <span className="block text-xs text-gray-400 mb-1">Estado</span>
              <div className="relative">
            ...
            {/* Date Range Filter */}
            <div>
              <span className="block text-xs text-gray-400 mb-1">Desde</span>
              <div className="relative">
            ...
            <div>
              <span className="block text-xs text-gray-400 mb-1">Hasta</span>
              <div className="relative">
                <Calendar className="w-5 h-5 absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                <input
                  type="date"
            ...
            {/* Payment Filter */}
            <div>
              <span className="block text-xs text-gray-400 mb-1">Pago</span>
              <div className="relative">
